 ...
 * move / delete constraints. Permission checks live in the use case (operator
 * resolved here).
 */
...
public class JulyOrganizationController {
     ...
     */
    public JulyOrganizationController(JulyOrganizationUseCase julyOrganizationUseCase,
            JulyOrganizationConverter julyOrganizationConverter) {
    ...
    public Response011<IdVo011> insert(@RequestBody JulyOrganizationInsertVo011 vo, HttpServletRequest request) {
        ...
        return Response011.successId(funcName,
                julyOrganizationUseCase.insert(operator.id(), vo.getOrgCode(), vo.getOrgName(), vo.getPkUser(),
    ...
    public Response011<IdVo011> update(@RequestBody JulyOrganizationUpdateVo011 vo, HttpServletRequest request) {
        ...
        julyOrganizationUseCase.update(operator.id(), vo.getId(), vo.getOrgName(), vo.getPkUser(), vo.getParentId(),
                vo.getSortOrder());
    ...
    public Response011<IdVo011> logicDelete(@RequestBody IdVo011 idVo, HttpServletRequest request) {
        ...
        julyOrganizationUseCase.logicDelete(operator.id(), idVo.getId());
    ...
    public Response011<JulyOrganizationVo011> getById(@RequestParam("id") String id, HttpServletRequest request) {
        String funcName = "get by id";
        Operator011 operator = Operator011Resolver.resolve(request);

        return Response011.success(funcName,
                julyOrganizationConverter.toVo(julyOrganizationUseCase.getById(operator.id(), id)));
    }
    ...
    public Response011<List<JulyOrganizationVo011>> getTree(HttpServletRequest request) {
        String funcName = "get tree";
        Operator011 operator = Operator011Resolver.resolve(request);

        JulyOrganizationUseCase.TreeWithCounts tree = julyOrganizationUseCase.getTree(operator.id());
    ...
    public Response011<PageResult011<JulyOrganizationVo011>> selectListByPage(
        ...
        PageResult011<JulyOrganization> page = julyOrganizationUseCase.selectListByPage(operator.id(), pageQuery,
                query.getKeyword());
    ...
    public Response011<ExportResult> export(HttpServletRequest request) {
        ...
        return Response011.success(funcName, julyOrganizationUseCase.export(operator));
    }
    ...
    public Response011<String> backup011(HttpServletRequest request) {
        ...
        return Response011.success(funcName, julyOrganizationUseCase.backup(operator));
    }
}
