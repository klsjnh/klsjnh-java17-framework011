...
import com.klsjnh.domain.storage.EditableTextPolicy;
...
public class StorageObjectUseCase {
    ...
    /**
     * Page object keys under a prefix.
     *
     * @param storageCode storage code
     * @param bucketName  bucket name
     * @param prefix      key prefix, nullable
     ...
     * @return page result
     */
    public PageResult011<String> selectListByPage(String storageCode, String bucketName, String prefix,
            Integer pageIndex, Integer pageSize) {
        PageQuery011 query = new PageQuery011(pageIndex, pageSize);
        List<String> all = adapter(storageCode).list(bucketName, prefix);
