...
/*                JulyMessageChannelUseCase class
 *
...
/**
 * JulyMessageChannel use cases: channel configuration CRUD.
 */

@Service
public class JulyMessageChannelUseCase {

    /**
     * Channel repository.
     */
    private final JulyMessageChannelRepository repository;
     ...
     */
    public JulyMessageChannelUseCase(JulyMessageChannelRepository repository) {
    ...
    public String insert(String channelCode, Integer sortOrder, String channelName, String providerType, String config,
        ...
        JulyMessageChannel channel = newChannel(channelCode, sortOrder, channelName, providerType, config, remark);
    ...
    public String update(String id, String channelName, String providerType, String config, Integer sortOrder,
        ...
        JulyMessageChannel channel = require(id);
     ...
     * @return aggregate
     */
    public JulyMessageChannel getById(String id) {
        return require(id);
    }
     ...
     * @return page result
     */
    public PageResult011<JulyMessageChannel> selectListByPage(PageQuery011 pageQuery, JulyMessageChannelQuerySpec spec) {
        PageQuery011 query = pageQuery == null ? new PageQuery011(1, 10) : pageQuery;
        JulyMessageChannelQuerySpec condition = spec == null ? new JulyMessageChannelQuerySpec(null, null) : spec;
        List<JulyMessageChannel> rows = repository.findPage(query.offset(), query.pageSize(), condition);
     ...
     */
    private JulyMessageChannel newChannel(String channelCode, Integer sortOrder, String channelName, String providerType,
            String config, String remark) {
        try {
            return JulyMessageChannel.create(EntityId.generate(), channelCode, sortOrder, channelName, providerType,
     ...
     * @return aggregate
     */
    private JulyMessageChannel require(String id) {
        JulyMessageChannel channel = repository.findById(id);
