...
Framework modules are consumed as **BOM + starters**: import `java17-bom011`, then add the starters you need (`java17-core011` is pulled in transitively; `java17-storage-minio011-starter` etc. are optional). See 015.project-info for the full 14-module map.
