...
-- （2026-09-24，按中心归并；曾用名 july_center_datasource.sql）
-- 2026-09-26：文件更名为 july_center_datasource011.sql（对齐 center-datasource011-starter）
-- 列顺序规范：id → 业务字段 → sort_order（有排序需求时）→ status → 审计四列 → dr
-- 设计：docs/infrastructure011/018.datasource-center/
