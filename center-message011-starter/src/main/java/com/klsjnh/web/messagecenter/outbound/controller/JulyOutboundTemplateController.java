...
public class JulyOutboundTemplateController {
    ...
    public Response011<IdVo011> insert(@RequestBody JulyOutboundTemplateInsertVo011 vo, HttpServletRequest request) {
    ...
    public Response011<IdVo011> update(@RequestBody JulyOutboundTemplateUpdateVo011 vo, HttpServletRequest request) {
    ...
    public Response011<PageResult011<JulyOutboundTemplateVo011>> selectListByPage(
            @RequestBody JulyOutboundTemplateQueryVo011 vo, HttpServletRequest request) {
