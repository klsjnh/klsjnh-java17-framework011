...
public class JulyInboundChannelController {
    ...
    public Response011<IdVo011> insert(@Valid @RequestBody JulyInboundChannelInsertVo011 vo, HttpServletRequest request) {
    ...
    public Response011<IdVo011> update(@Valid @RequestBody JulyInboundChannelUpdateVo011 vo, HttpServletRequest request) {
    ...
    public Response011<PageResult011<JulyInboundChannelVo011>> selectListByPage(
            @Valid @RequestBody JulyInboundChannelQueryVo011 vo, HttpServletRequest request) {
