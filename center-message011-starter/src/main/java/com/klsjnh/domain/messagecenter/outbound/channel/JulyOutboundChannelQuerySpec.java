...
/*                JulyOutboundChannelQuerySpec class
 *
...
/**
 * JulyOutboundChannel page query condition: an optional keyword matched against
...
public record JulyOutboundChannelQuerySpec(String keyword, String status) {
     ...
     * @param status  row status filter, nullable for all
     */
    public JulyOutboundChannelQuerySpec {
