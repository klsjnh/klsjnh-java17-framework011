 ...
 *          modify history
 *
 *      2026.09.15  july storage query spec class
 *
 */
...
/**
 * JulyStorage page query condition: an optional keyword matched against code /
 * name, an optional provider filter, plus an optional status filter.
 *
...
public record JulyStorageQuerySpec(String keyword, String provider, String status) {
