...
/*                JulyMessageChannelRepository interface
 *
...
/**
 * Repository port for the JulyMessageChannel aggregate.
 */

public interface JulyMessageChannelRepository {
     ...
     */
    void insert(JulyMessageChannel channel);
     ...
     */
    void update(JulyMessageChannel channel);
     ...
     */
    JulyMessageChannel findById(String id);
     ...
     * @return aggregate or null
     */
    JulyMessageChannel findByCode(String channelCode);
     ...
     * @return aggregate or null
     */
    JulyMessageChannel findEnabledByCode(String channelCode);
     ...
     * @return page rows
     */
    List<JulyMessageChannel> findPage(int offset, int pageSize, JulyMessageChannelQuerySpec spec);
     ...
     */
    long count(JulyMessageChannelQuerySpec spec);
}
