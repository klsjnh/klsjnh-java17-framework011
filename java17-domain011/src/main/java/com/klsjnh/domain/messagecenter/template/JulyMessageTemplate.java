...
public class JulyMessageTemplate {
     ...
     */
    public JulyMessageTemplate(EntityId id, String templateCode, Integer sortOrder, String templateName,
     ...
     */
    public static JulyMessageTemplate create(EntityId id, String templateCode, Integer sortOrder, String templateName,
            String channelCode, String title, String content, String remark, AuditInfo audit) {
        return new JulyMessageTemplate(id, templateCode, sortOrder, templateName, channelCode, title, content,
