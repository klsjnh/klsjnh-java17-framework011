...
/**
 * JulyOutboundChannel aggregate root (message center context): one channel
...
public class JulyOutboundChannel {
     ...
     */
    public JulyOutboundChannel(EntityId id, String channelCode, Integer sortOrder, String channelName,
     ...
     */
    public static JulyOutboundChannel create(EntityId id, String channelCode, Integer sortOrder, String channelName,
            String providerType, String config, String remark, AuditInfo audit) {
        return new JulyOutboundChannel(id, channelCode, sortOrder, channelName, providerType, config,
