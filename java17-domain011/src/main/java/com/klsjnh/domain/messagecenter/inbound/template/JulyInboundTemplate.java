...
public class JulyInboundTemplate {
     ...
     */
    public JulyInboundTemplate(EntityId id, String templateCode, Integer sortOrder, String templateName,
     ...
     */
    public static JulyInboundTemplate create(EntityId id, String templateCode, Integer sortOrder, String templateName,
            String channelCode, String title, String content, String remark, AuditInfo audit) {
        return new JulyInboundTemplate(id, templateCode, sortOrder, templateName, channelCode, title, content,
