...
/*                JulyOutboundChannelRepository interface
 *
...
/**
 * Repository port for the JulyOutboundChannel aggregate.
 */

public interface JulyOutboundChannelRepository {
     ...
     */
    void insert(JulyOutboundChannel channel);
     ...
     */
    void update(JulyOutboundChannel channel);
     ...
     */
    JulyOutboundChannel findById(String id);
     ...
     * @return aggregate or null
     */
    JulyOutboundChannel findByCode(String channelCode);
     ...
     * @return aggregate or null
     */
    JulyOutboundChannel findEnabledByCode(String channelCode);
     ...
     * @return page rows
     */
    List<JulyOutboundChannel> findPage(int offset, int pageSize, JulyOutboundChannelQuerySpec spec);
     ...
     */
    long count(JulyOutboundChannelQuerySpec spec);
}
