...
/*                JulyInboundTemplateRepository interface
 *
...
/**
 * Repository port for the JulyInboundTemplate aggregate.
 */

public interface JulyInboundTemplateRepository {
     ...
     */
    void insert(JulyInboundTemplate template);
     ...
     */
    void update(JulyInboundTemplate template);
     ...
     */
    JulyInboundTemplate findById(String id);
     ...
     * @return aggregate or null
     */
    JulyInboundTemplate findByCode(String templateCode);
     ...
     * @return aggregate or null
     */
    JulyInboundTemplate findEnabledByCode(String templateCode);
     ...
     * @return page rows
     */
    List<JulyInboundTemplate> findPage(int offset, int pageSize, JulyInboundTemplateQuerySpec spec);
     ...
     */
    long count(JulyInboundTemplateQuerySpec spec);
}
