...
/*                JulyMessageTemplateQuerySpec class
 *
...
/**
 * JulyMessageTemplate page query condition: an optional keyword matched against
...
public record JulyMessageTemplateQuerySpec(String keyword, String channelCode, String status) {
     ...
     * @param status      row status filter, nullable for all
     */
    public JulyMessageTemplateQuerySpec {
