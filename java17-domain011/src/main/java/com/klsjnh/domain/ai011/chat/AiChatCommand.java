package com.klsjnh.domain.ai011.chat;

/*                AiChatCommand record
 *
...
public record AiChatCommand(String baseUrl, String apiKey, String model, List<AiChatMessage> messages,
