package com.klsjnh.application.organization;
...
public class JulyOrganizationUseCase {
     ...
     */
    @Transactional
    public String insert(String orgCode, String orgName, String pkUser, String parentId, Integer sortOrder) {
     ...
     */
    @Transactional
    public String update(String id, String orgName, String pkUser, String parentId, Integer sortOrder) {
     ...
     * @return aggregate
     */
    public JulyOrganization getById(String id) {
        return require(id);
    }

    /**
     * Load the full alive organization tree with member counts.
     *
     * @return tree plus a orgId → member count map
     */
    public TreeWithCounts selectTree() {
        return new TreeWithCounts(repository.selectOrgTree(), userRepository.countByOrgGrouped());
    }
     ...
     * @return page result
     */
    public PageResult011<JulyOrganization> selectListByPage(PageQuery011 pageQuery, String keyword) {
