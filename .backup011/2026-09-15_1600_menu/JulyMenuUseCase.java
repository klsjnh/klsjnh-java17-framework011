package com.klsjnh.application.menu;
...
/**
 * JulyMenu use cases: menu CRUD / tree, plus selectUserMenuTree — the
...
public class JulyMenuUseCase {
     ...
     */
    public List<JulyMenu> selectTree() {
        return repository.selectMenuTree();
    }

    /**
     * Select the navigation menu tree of the current operator: user → roles →
     ...
     * @return root nodes with nested children
     */
    public List<JulyMenu> selectUserMenuTree(String operatorId) {
