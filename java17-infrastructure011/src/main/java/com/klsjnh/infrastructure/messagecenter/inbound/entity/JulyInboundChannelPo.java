...
/**
 * Channel persistence PO mapped to july_message_inbound_channel, a sorted table
 * (BasePo011 adds sort_order).
 */

@Data
@EqualsAndHashCode(callSuper = true)
@TableName("july_message_inbound_channel")
public class JulyInboundChannelPo extends BasePo011 {
