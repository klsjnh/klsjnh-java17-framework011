...
/*                JulyInboundChannelMapper interface
 *
...
/**
 * MyBatis-Plus mapper for the july_message_inbound_channel table.
 */

@Mapper
public interface JulyInboundChannelMapper extends BaseMapper<JulyInboundChannelPo> {
}
