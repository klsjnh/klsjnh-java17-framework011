...
/**
 * Template persistence PO mapped to july_message_outbound_template, a sorted table
 * (BasePo011 adds sort_order).
 */

@Data
@EqualsAndHashCode(callSuper = true)
@TableName("july_message_outbound_template")
public class JulyOutboundTemplatePo extends BasePo011 {
