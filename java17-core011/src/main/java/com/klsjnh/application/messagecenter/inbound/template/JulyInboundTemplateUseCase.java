package com.klsjnh.application.messagecenter.inbound.template;

/*                JulyInboundTemplateUseCase class
 *
...
/**
 * JulyInboundTemplate use cases: message template CRUD.
 */

@Service
public class JulyInboundTemplateUseCase {
    ...
    public String insert(String templateCode, Integer sortOrder, String templateName, String channelCode, String title,
        ...
        JulyInboundTemplate template = newTemplate(templateCode, sortOrder, templateName, channelCode, title, content,
                remark);
     ...
     */
    private JulyInboundTemplate newTemplate(String templateCode, Integer sortOrder, String templateName,
            String channelCode, String title, String content, String remark) {
        try {
            return JulyInboundTemplate.create(EntityId.generate(), templateCode, sortOrder, templateName, channelCode,
     ...
     * @return aggregate
     */
    private JulyInboundTemplate require(String id) {
        JulyInboundTemplate template = repository.findById(id);
