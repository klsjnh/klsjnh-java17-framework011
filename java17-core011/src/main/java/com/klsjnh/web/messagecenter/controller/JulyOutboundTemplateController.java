...
import com.klsjnh.web.messagecenter.converter.JulyOutboundTemplateConverter;

import com.klsjnh.web.global.audit.AuditLog;
import com.klsjnh.web.messagecenter.vo.template.JulyOutboundTemplateInsertVo011;
import com.klsjnh.web.messagecenter.vo.template.JulyOutboundTemplateQueryVo011;
import com.klsjnh.web.messagecenter.vo.template.JulyOutboundTemplateUpdateVo011;
...
public class JulyOutboundTemplateController {
    ...
    public Response011<IdVo011> insert(@RequestBody JulyOutboundTemplateInsertVo011 vo) {
        String funcName = "insert";

        return Response011.successId(funcName, julyOutboundTemplateUseCase.insert(vo.getTemplateCode(),
    ...
    public Response011<IdVo011> update(@RequestBody JulyOutboundTemplateUpdateVo011 vo) {
        String funcName = "update";

        return Response011.successId(funcName, julyOutboundTemplateUseCase.update(vo.getId(), vo.getTemplateName(),
    ...
    public Response011<IdVo011> logicDelete(@RequestBody IdVo011 idVo) {
        ...
        return Response011.successId(funcName, julyOutboundTemplateUseCase.logicDelete(idVo.getId()));
    }
    ...
    public Response011<BatchDeleteResultVo011> logicDeleteBatch(@RequestBody IdsVo011 idsVo) {
        ...
        return Response011.success(funcName, julyOutboundTemplateUseCase.logicDeleteBatch(idsVo.getIds()));
    }
    ...
    public Response011<JulyOutboundTemplateVo011> getById(@RequestParam("id") String id) {
        String funcName = "get by id";

        return Response011.success(funcName, julyOutboundTemplateConverter.toVo(julyOutboundTemplateUseCase.getById(id)));
    }
    ...
    public Response011<PageResult011<JulyOutboundTemplateVo011>> selectListByPage(
            @RequestBody JulyOutboundTemplateQueryVo011 vo) {
        String funcName = "select list by page";

        PageQuery011 pageQuery = new PageQuery011(vo.getPageIndex(), vo.getPageSize());
        PageResult011<JulyOutboundTemplate> page = julyOutboundTemplateUseCase.selectListByPage(pageQuery,
