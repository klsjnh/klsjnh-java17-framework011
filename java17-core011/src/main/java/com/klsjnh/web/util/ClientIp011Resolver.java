 ...
 * fixes this is reserved in {@code krt.web.trusted-proxies} (KrtSecurityConfig011) and
 * is not consumed yet — a deliberate, documented trade-off rather than an
 * oversight. Web cannot read KrtSecurityConfig011 (it sits in infrastructure), so
