...
/*                JulyInboundChannelQuerySpec class
 *
...
/**
 * JulyInboundChannel page query condition: an optional keyword matched against
...
public record JulyInboundChannelQuerySpec(String keyword, String status) {
     ...
     * @param status  row status filter, nullable for all
     */
    public JulyInboundChannelQuerySpec {
