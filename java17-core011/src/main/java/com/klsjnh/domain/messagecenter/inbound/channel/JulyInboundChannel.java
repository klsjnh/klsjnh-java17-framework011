...
/**
 * JulyInboundChannel aggregate root (message center context): one channel
...
public class JulyInboundChannel {
     ...
     */
    public JulyInboundChannel(EntityId id, String channelCode, Integer sortOrder, String channelName,
     ...
     */
    public static JulyInboundChannel create(EntityId id, String channelCode, Integer sortOrder, String channelName,
            String providerType, String config, String remark, AuditInfo audit) {
        return new JulyInboundChannel(id, channelCode, sortOrder, channelName, providerType, config,
