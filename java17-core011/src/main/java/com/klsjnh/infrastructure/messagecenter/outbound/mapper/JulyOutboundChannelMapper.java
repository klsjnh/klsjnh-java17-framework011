...
/*                JulyOutboundChannelMapper interface
 *
...
/**
 * MyBatis-Plus mapper for the july_message_outbound_channel table.
 */

@Mapper
public interface JulyOutboundChannelMapper extends BaseMapper<JulyOutboundChannelPo> {
}
