package com.klsjnh.infrastructure.datasource.management.runner;
...
import com.klsjnh.domain.datasource.kernel.DatasourceSeedPort;
...
import com.klsjnh.infrastructure.datasource.management.repository.JulyDatasourceRepositoryImpl;
...
public class DatasourceSeedRunner implements ApplicationRunner {
     ...
     */
    public DatasourceSeedRunner(KrtDatasourceConfig011 krtConfig, DatasourceSeedPort seedPort,
