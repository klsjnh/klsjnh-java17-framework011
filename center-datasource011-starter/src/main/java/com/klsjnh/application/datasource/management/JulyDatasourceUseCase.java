 ...
 *      2026.09.26  explicit permission checks (julyDatasource auth)
 *
 */
...
import com.klsjnh.domain.datasource.management.JulyDatasourcePermissionCodes011;
...
public class JulyDatasourceUseCase {
    ...
    public JulyDatasourceUseCase(JulyDatasourceRepository repository, DynamicDataSourceRegistryPort registry,
            DataSourceProbePort probePort, AuthorizationPort authorizationPort) {
     ...
     */
    @Transactional
    public String insert(String operatorId, String dsCode, Integer sortOrder, String dsName, String dbType,
            String jdbcUrl, String schemaName, String username, String password, String driverClass, String remark) {
        authorizationPort.assertHas(operatorId, JulyDatasourcePermissionCodes011.INSERT);
     ...
     */
    @Transactional
    public String update(String operatorId, String id, String dsName, Integer sortOrder, String dbType, String jdbcUrl,
            String schemaName, String username, String password, String driverClass, String remark) {
        authorizationPort.assertHas(operatorId, JulyDatasourcePermissionCodes011.UPDATE);
    ...
    public String logicDelete(String operatorId, String id) {
        authorizationPort.assertHas(operatorId, JulyDatasourcePermissionCodes011.LOGIC_DELETE);
     ...
     * @return aggregate
     */
    public JulyDatasource getById(String operatorId, String id) {
        authorizationPort.assertHas(operatorId, JulyDatasourcePermissionCodes011.SELECT);
        return require(id);
    }
     ...
     * @return page result
     */
    public PageResult011<JulyDatasource> selectListByPage(String operatorId, PageQuery011 pageQuery,
            JulyDatasourceQuerySpec spec) {
        authorizationPort.assertHas(operatorId, JulyDatasourcePermissionCodes011.SELECT);
     ...
     * @return probe result
     */
    public DataSourceProbePort.ProbeResult testDraft(String operatorId, String dsCode, String dbType, String jdbcUrl,
            String username, String password, String driverClass) {
        authorizationPort.assertHas(operatorId, JulyDatasourcePermissionCodes011.TEST_CONNECTION);
        requireDbType(dbType);
     ...
     * @return probe result
     */
    public DataSourceProbePort.ProbeResult testSaved(String operatorId, String id, String password) {
        authorizationPort.assertHas(operatorId, JulyDatasourcePermissionCodes011.TEST_CONNECTION);
        JulyDatasource datasource = require(id);
     ...
     */
    public ReloadResult reloadRegistry(String operatorId) {
        authorizationPort.assertHas(operatorId, JulyDatasourcePermissionCodes011.RELOAD_REGISTRY);
        return doReloadRegistry();
    }

    /**
     * Reload the registry without a permission check (internal write path).
     *
     * @return reconciliation summary
     */
    private ReloadResult doReloadRegistry() {
