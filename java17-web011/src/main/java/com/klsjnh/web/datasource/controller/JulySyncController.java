...
public class JulySyncController {
    ...
    public Response011<IdVo011> insert(@RequestBody JulySyncInsertVo011 vo) {
        ...
        String id = syncRuleUseCase.insert(vo.getSyncCode(), vo.getSyncName(), vo.getSourceDsCode(), vo.getSourceKind(),
                vo.getSourceData(), vo.getTargetDsCode(), vo.getTargetKind(), vo.getTargetData(), vo.getMode(),
                vo.getSyncKey(), vo.getConflict(), vo.getPageSize(), vo.getRemark(), columns);
    ...
    public Response011<PageResult011<JulySyncRuleVo011>> selectListByPage(@RequestBody JulySyncQueryVo011 vo) {
        ...
        PageResult011<JulySyncRule> page = syncRuleUseCase.selectListByPage(query, spec);
    ...
    public Response011<IdVo011> logicDelete(@RequestBody IdVo011 idVo) {
        ...
        return Response011.successId(funcName, syncRuleUseCase.logicDelete(idVo.getId()));
    }
    ...
    public Response011<SyncRunResult> run(@RequestBody JulySyncRunVo011 vo) {
        String funcName = "sync rule run";

        return Response011.success(funcName, syncRuleUseCase.run(vo.getSyncCode()));
    }
