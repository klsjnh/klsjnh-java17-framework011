...
@Data
public class JulyMessageQueryVo011 {
    ...
    /** Exact send status filter, blank for all. */
    @Schema(description = "发送状态过滤（PENDING / SUCCESS / FAILED，留空为全部）")
