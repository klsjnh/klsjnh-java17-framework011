...
/*                JulyMessageTemplateConverter class
 *
...
/**
 * Converter between the JulyMessageTemplate aggregate and the response VO.
 */

@Component
public class JulyMessageTemplateConverter {
     ...
     * @return response VO
     */
    public JulyMessageTemplateVo011 toVo(JulyMessageTemplate template) {
        JulyMessageTemplateVo011 vo = new JulyMessageTemplateVo011();
     ...
     */
    public List<JulyMessageTemplateVo011> toVoList(List<JulyMessageTemplate> templates) {
        List<JulyMessageTemplateVo011> result = new ArrayList<>();

        for (JulyMessageTemplate template : templates) {
